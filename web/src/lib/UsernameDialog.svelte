...
<div class={containerCls}>
  ...
  <label class="flex flex-col gap-4 text-center">
    ...
    <input bind:value={username} type="text" placeholder="Tell us your name" class="p-2 pr-4 pl-4 bg-slate-700">
  </label>

  <div class="text-right pt-4">
    <button class="hover:bg-slate-700 rounded p-2 pr-3 pl-3" on:click={onSubmit}>Go!</button>
  </div>
</div>